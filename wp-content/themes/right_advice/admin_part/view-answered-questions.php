...
<div class="" style="margin:5% 2%">
	<h3>All Questions & Answer<br><br><a href="all-questions-answer.php" class="btn btn-default">Unanswered Questions</a><a href="javascript:void(0)" class="btn btn-info">Answered Questions</a></h3>
	<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		...
		<?php 
			$sno = 0;
			$query = mysql_query("select * from ra_question where status=1") or die(mysql_error());
		...
		?>
			<tr id="item_<?=$rows['id']?>">
				...
				<td>
					<a href="javascript:void(0)" onclick="deleteQuestion('<?=$rows['id']?>','Answered')" class="btn btn-danger"> <i class="fa fa-trash"></i> </a>
				</td>
			</tr>
		<?php }?>
		</tbody>
